...
class ScoreControl : public ScreenTextController {
 public:
  ...
  void setHomeScore(const std::string& score) {
    home_score_entry->setValue(score);
    homeUpdated();
  }
  void setAwayScore(const std::string& score) {
    away_score_entry->setValue(score);
    awayUpdated();
  }
  void setHomeName(const std::string& name) {
    home_name_entry->setValue(name);
    homeNameUpdated();
  }
  void setAwayName(const std::string& name) {
    away_name_entry->setValue(name);
    awayNameUpdated();
  }
  ...
  void clickToggleIntro() {
    team_intro_button->toggle();
    toggleIntroMode();
  }
